...
all_df = pd.read_csv("https://raw.githubusercontent.com/fawazatha/EDA-Dicoding/main/Dashboard/all_data.csv")
...
with st2:
    st.markdown(f"Total Revenue: **R$ {total_revenue_formatted}**")
...
with col1:
    st.markdown(f"Total Spend: **{total_spend}**R$")
